                        ...
                        <div className="grid grid-cols-1 gap-2">
                            {workflows.map((item, idx) => (
                                <button
                                    ...
                                    className={`group relative flex items-center gap-4 overflow-hidden rounded-xl border p-4 text-left transition-all duration-200 ${isDarkMode
                                    ...
                                    <div className="flex-1">
                                        <h4 className={`mb-0.5 font-outfit text-[14px] font-bold tracking-tight ${isDarkMode ? 'text-slate-200' : 'text-slate-900'}`}>
                                            {item.title}
                                        </h4>
                                        <p className={`text-[11px] font-medium leading-relaxed opacity-40 ${isDarkMode ? 'text-slate-500' : 'text-slate-500'}`}>
                                            {item.desc}
                                        </p>
                                    </div>
