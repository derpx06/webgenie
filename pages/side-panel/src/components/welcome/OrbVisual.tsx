    ...
    return (
        <div className="relative flex size-64 items-center justify-center">
            ...
            <div className="relative z-10 flex items-center justify-center">
                ...
                <div className={`absolute size-40 rounded-full opacity-40 blur-2xl ${isDarkMode ? 'bg-violet-400/40' : 'bg-purple-500/20'}`} />

                <img
                    src="/webgenie-logo.png"
                    alt="WebGenie Logo"
                    className="relative z-10 size-36 object-contain drop-shadow-[0_0_25px_rgba(34,211,238,0.6)] transition-transform duration-700 hover:scale-105"
                    style={{ filter: isDarkMode ? 'drop-shadow(0 0 15px rgba(139,92,246,0.5))' : 'none' }}
                />
            </div>
        </div>
    );
