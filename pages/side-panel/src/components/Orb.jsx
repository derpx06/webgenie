...
export default function Orb({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        backgroundColor: { value: hexToVec4(backgroundColor) },
    ...
    const update = t => {
      ...
      program.uniforms.backgroundColor.value = hexToVec4(backgroundColor);
  ...
  }, [hue, hoverIntensity, rotateOnHover, forceHoverState, backgroundColor, color1, color2, color3, innerRadius]);
